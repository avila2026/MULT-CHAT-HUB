...
export default function ChatArea() {
  ...
  const { messages, currentChannel, sendMessage, thinkingLevel, setThinkingLevel, transcribeAudio, uploadDataset } = ctx;
      ...
      <div className="p-4 bg-zinc-50 border-t border-zinc-200 shadow-inner">
        <div className="flex gap-2 items-center bg-white p-2 rounded-xl border border-zinc-300 focus-within:ring-2 ring-indigo-500/20 transition-all shadow-sm">
          ...
          <button
            ...
            title="Carregar dataset CSV ou JSON"
          >
          ...
          <input
            ...
            placeholder="Mensagem ou comando (ex: /use_tool analyze_descriptive {...})..."
          />
          <button
            onClick={handleSend}
